...
//       case 'current_weight':
//         if (age < 12) return {'min': 20, 'max': 80};
//         if (age < 18) return {'min': 30, 'max': 120};
//         if (age < 50) return {'min': 40, 'max': 200};
//         return {'min': 35, 'max': 150};
      
//       case 'goal_weight':
//         final healthyMin = (currentWeight * 0.7).round().clamp(30, 250);
//         final healthyMax = (currentWeight * 1.3).round().clamp(40, 250);
//         return {'min': healthyMin, 'max': healthyMax};
      
//       case 'height':
//         if (currentWeight < 40) return {'min': 100, 'max': 220};
//         if (currentWeight > 150) return {'min': 150, 'max': 250};
//         if (age < 12) return {'min': 80, 'max': 160};
//         if (age < 18) return {'min': 140, 'max': 200};
